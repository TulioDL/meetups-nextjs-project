...
;// CONCATENATED MODULE: ./pages/index.js
 ...
 //his will not be included in the client side bundle because is only used in getStaticProps
...
const getStaticProps = async ()=>{
    ...
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://tuliodl:18549750@cluster0.qaco1.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
